...
function insertNewRecord(data) {
    ...
    cell3.innerHTML = data.gmail;
    cell4 = newRow.insertCell(3);
    cell4.innerHTML = data.salry;
...
function onEdit(td) {
    ...
    document.getElementById("gmail").value = selectedRow.cells[2].innerHTML;
    document.getElementById("salry").value = selectedRow.cells[3].innerHTML;
    document.getElementById("phone").value = selectedRow.cells[4].innerHTML;
}
function updateRecord(formData) {
    selectedRow.cells[0].innerHTML = formData.fullName;
    selectedRow.cells[1].innerHTML = formData.empCode;
    selectedRow.cells[2].innerHTML = formData.gmail;
    selectedRow.cells[3].innerHTML = formData.salry;
